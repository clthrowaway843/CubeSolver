const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-AqusvlJS.js","assets/index-DmQZk0vk.js","assets/index-DwGVAMoy.css"])))=>i.map(i=>d[i]);
import{y as e,_ as B,K as D,v as t}from"./index-DmQZk0vk.js";import{p as R}from"./chunk-Y3BVWVFU-CZjqCxXa.js";var a=null;async function S(){return a??(a=n())}async function n(){return R(await e.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg U R' U' L B R' B' R
Alg R' U' R U B' U' B L`)}export{S as cachedData222,u as cachedMegaminxKPuzzleWithoutMO,h as cachedSGSDataMegaminx,s as sgsDataPyraminx,b as sgsDataPyraminxFixedOrientation,f as sgsDataSkewb,G as sgsDataSkewbFixedCorner,d as skewbKPuzzleWithoutMOCached};
